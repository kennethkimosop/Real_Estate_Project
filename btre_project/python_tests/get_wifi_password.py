...
if len(profile_names) != 0:
    for name in profile_names:
        ...
        profile_info = subprocess.run(["netsh", "wlan", "show", "profile", name], capture_output = True).stdout.decode("utf-8", errors="ignore")
        ...
        if re.search("Security key           : Absent", profile_info):
            ...
            profile_info_pass = subprocess.run(["netsh", "wlan", "show", "profile", name, "key=clear"], capture_output = True).stdout.decode("utf-8",errors="ignore")
